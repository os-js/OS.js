...
# OS.js v3 official demo Docker image
...
This is just a basic demo of OS.js v3 using the base distro repository.

```
docker run -p 8000:8000 osjs/osjs:v3
```

* https://hub.docker.com/r/osjs/osjs
* https://github.com/os-js/OS.js/tree/v3-demo
